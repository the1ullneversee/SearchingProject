...
public:
	...
	std::string fillMetaData(_searchType srchType, _container_type conType, std::string time, std::size_t idToUse, std::string origin);
	std::size_t ContainerID; //The object ID instance
	std::string metaDataName;
	int container;
	void saveContainer(DataWrapper& dwrapSwap);
